...
function Sidebar() {
  ...
  // Insert new menu items below "Vendor Management"
  const cardApplicationsItem = { 
    title: 'Card Applications', 
    icon: <BadgeIcon />, 
    link: '/CardApplications' 
  };
  
  const posManagementItem = {
    title: 'POS Account Management',
  ...
  const menuItems = insertIndex !== -1
    ? [
        ...
        posManagementItem, // ✅ Added POS Management
        stallsReportItem,  
    ...
    : [...SidebarData, cardApplicationsItem, supportItem, posManagementItem, stallsReportItem];
